...
func (h *Handler) CreateTask(c *gin.Context) {
	...
	userIDStr, ok := auth.GetUserUUID(c)
	if !ok {
	...
	log.Info("user authenticated", slog.String("user_id", userIDStr))
	...
	task, err := h.service.CreateTask(c.Request.Context(), userIDStr, &req)
	if err != nil {
...
func (h *Handler) GetTasks(c *gin.Context) {
	...
	tasks, err := h.service.GetTasksByUserID(c.Request.Context(), userIDStr)
	if err != nil {
