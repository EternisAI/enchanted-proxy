...
// Legacy streaming endpoints have been replaced by WebSocket-based chat streaming.
// New endpoint: WS /api/v1/chats/:chatId/stream
//
// Removed endpoints:
// - GET /api/v1/chats/:chatId/active-stream
// - GET /api/v1/chats/:chatId/messages/:messageId/stream
// - GET /api/v1/chats/:chatId/messages/:messageId/status
